...
def search_markup(
    ...
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(
                text="·𝙲𝙻𝙾𝚂𝙴 𝙼𝙴𝙽𝚄·", callback_data=f"forceclose {query}|{user_id}"
            ),
            InlineKeyboardButton(
                text="⏭", callback_data=f"popat 1|{query}|{user_id}"
            ),
...
def secondary_markup(videoid, user_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="·𝙼𝙾𝚁𝙴 𝚁𝙴𝚂𝚄𝙻𝚃·", callback_data=f"other {videoid}|{user_id}"
            ),
...
def primary_markup(videoid, user_id, current_time, total_time):
    ...
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(text="·𝙼𝙾𝚁𝙴 𝚁𝙴𝚂𝚄𝙻𝚃·", callback_data=f"close"),
        ],
    ]
    return buttons
